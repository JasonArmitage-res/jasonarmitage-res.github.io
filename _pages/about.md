...
Right now, I am working on creating evaluations for large multimodal AI systems on tasks set in the physical worlds, cross-modal agent-based pipelines to improve accessibility to scientific data, and designing algorithms to assist VLM models to reason over 3D scenes.
